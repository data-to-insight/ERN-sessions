...
files = st.file_uploader(
    "Please upload CIN benchamrking data", accept_multiple_files=True
)
...
if files:
    ...
    b1_columns = [
        f"b1_children_in_need_{column}" if (not column in permenant_columns) else column
        for column in dfs["b1_children_in_need"].columns
    ]
